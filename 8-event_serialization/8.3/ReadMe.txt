========================================================================
    Win32 アプリケーション: win32thunk プロジェクトの概要
========================================================================

この win32thunk アプリケーションは、AppWizard により作成されました。
...
win32thunk.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル win32thunk.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル win32thunk.rc 
    にインクルードされます。
